import torch
from cirilla.RL.GRPO.grpo_pipeline import GRPO_DBMS, GRPO_Engine
from cirilla.Cirilla_model import get_optims, Cirilla, Args, CirillaTokenizer

if __name__ == '__main__': # required for multiprocessing (vllm)
    ...
    gen_config = {'batch_size': 256, 'n_generate_with_kv_cache': 3,
                'n_generate_naive': 0, 'generate_mistral': 0,
